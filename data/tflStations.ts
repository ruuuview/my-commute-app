...
export const TFL_STATIONS: TfLStation[] = [
  ...
  { id: 'city-of-london',   name: 'City Thameslink',       lines: ['overground'],                             zone: 1 },
  ...
  { id: 'fenchurch-street', name: 'Fenchurch Street',      lines: ['overground'],                             zone: 1 },
  ...
  { id: 'moorgate',         name: 'Moorgate',              lines: ['circle','hammersmith-city','metropolitan','northern'], zone: 1 },
  ...
  { id: 'lewisham',         name: 'Lewisham',              lines: ['dlr'],                                    zone: 3 },
