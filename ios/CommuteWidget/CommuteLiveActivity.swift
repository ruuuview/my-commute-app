...
struct CountdownView: View {
    ...
    var body: some View {
        if let epoch = nextTrainEpoch, epoch > Foundation.Date().timeIntervalSince1970 {
            Text(timerInterval: Foundation.Date()...Foundation.Date(timeIntervalSince1970: epoch), countsDown: true)
                .font(font)
